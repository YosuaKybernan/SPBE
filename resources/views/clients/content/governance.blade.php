...
@section('title', 'SPBE - Tata Kelola SPBE')
...
@section('content-body')
    <main id="main">
        ...
        <section id="governance" class="about mt-5">
            <div class="container mt-5" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-12">
                        <div class="accordion" id="accordionGovernance">
                            @foreach ($aspects as $index => $aspect)
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseGovAspect{{ $index + 2 }}" aria-expanded="false"
                                            aria-controls="collapseGovAspect{{ $index + 2 }}"
                                            style="font-size: 20px; font-weight: 500">
                                            {{ $aspect['title'] }}
                                        </button>
                                    </h2>
                                    <div id="collapseGovAspect{{ $index + 2 }}" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionGovernance">
