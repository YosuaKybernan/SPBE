            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        <img src="{{ asset('assets/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle"> {{-- Profile Picture --}}
                        <h2>Kevin Anderson</h2> {{-- Full Name --}}
                        <h3>Web Designer</h3> {{-- Job Position --}}
