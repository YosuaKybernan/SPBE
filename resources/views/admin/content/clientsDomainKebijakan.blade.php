...
@section('title', 'Admin SPBE - Klien - Domain Kebijakan')

@section('page-title')
    Klien - Domain Kebijakan
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3 align-items-center">
                            <div class="col-sm-10">
                                <h5 class="card-title" id="cardTitle">Daftar Domain Kebijakan</h5>
                            </div>
                        ...
                        <!-- Form untuk Create Domain Kebijakan -->
                        <div class="row mb-3" id="createForm" style="display: none;">
                            <form action="{{ route('admin.domain.kebijakan.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    @foreach ($domains as $domain)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <form action="{{ route('admin.domain.kebijakan.delete', $domain->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editDomainModalLabel">Ubah Domain Kebijakan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.domain.kebijakan.update', $domain->id) }}" method="POST">
                        @csrf
